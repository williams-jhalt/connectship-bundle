...
class DeleteTransmitItemsRequest
{
     ...
     */
    public function __construct($carrier, $shipper, $transmitItems, $preProcess, $postProcess, $locale, $asyncCorrelationData)
    {
    ...
    /**
     * @param string $carrier
     * @return \Williams\ConnectshipBundle\AMP\DeleteTransmitItemsRequest
     */
